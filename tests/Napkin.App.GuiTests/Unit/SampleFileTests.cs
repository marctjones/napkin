...
public class SampleFileTests
{
    ...
    public void The_samples_ship_beside_the_application()
    {
        ...
        Assert.Equal(
            ["Coffee table", "Rounded-corner table", "Wall with window", "Bookcase", "Bench", "Lying beam", "Chain of five", "Fraction stress", "Scale extremes", "Framing at 16\" o.c.", "L-bracket", "Overlap", "Picture frame"],
