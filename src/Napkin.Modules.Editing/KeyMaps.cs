...
public enum EditCommand
{
    ...
    /// <summary>Draw → Porch roof (Shift+R).</summary>
    RoofTool,
    ...
    /// <summary>Firm up the selection, or every part: proposed relationships, stock and sizes (docs/design/sketch-mode.md &#xA7;3).</summary>
    FirmUp,
...
public static class KeyMaps
{
    ...
    public static KeyMap<EditCommand> Edit { get; } = new(
        [
            ...
            new(Shift(KeyName.R), EditCommand.RoofTool),
            ...
            new(K(KeyName.F), EditCommand.FirmUp),
        ...
        new Dictionary<EditCommand, string>
        {
            ...
            [EditCommand.RoofTool] = "Porch roof tool: click a deck; a shed roof covers it, high at the ledger, low on the wall at its far edge",
            ...
            [EditCommand.FirmUp] = "Firm up the selection, or every part: the relationships touching parts imply, the nearest stock, the drawn sizes stated",
