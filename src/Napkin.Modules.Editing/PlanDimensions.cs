...
/// <summary>
/// Turns the <see cref="Dimension"/> entities of a sketch into measurements laid out in the plan.
/// </summary>
/// <remarks>
/// Pure and UI-free on purpose. The canvas calls it to draw, an exporter to write the same lines
/// (#23), and a test to read what a label says, with no second implementation of the arithmetic.
/// </remarks>
public static class PlanDimensions
{
