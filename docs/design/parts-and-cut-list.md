...
Status: **Implemented, audited 0.93.0-beta (M3, 2026-09-25).** §4 (the shopping list, #9) was implemented on 2026-09-24 at Marc's direction; its worked example is a new `samples/stocked-bench` (§8.3), not the coffee table. Written as part of issue #7 (the materials
